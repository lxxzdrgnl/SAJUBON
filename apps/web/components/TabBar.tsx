...
export default function TabBar() {
  ...
  return (
    <nav className="fixed bottom-[calc(0.875rem+env(safe-area-inset-bottom))] left-1/2 flex w-[calc(100%-28px)] max-w-[612px] -translate-x-1/2 overflow-hidden rounded-lg border-2 border-ink bg-surface shadow-brutal md:bottom-auto md:top-3.5">
